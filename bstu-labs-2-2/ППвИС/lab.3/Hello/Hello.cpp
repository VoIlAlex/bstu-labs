		...
		case WM_COMMAND:
			...
			switch (wmId)
			{
				case IDM_ABOUT:
				   ...
				   break;
				case IDM_EXIT:
				   if(MessageBox(hWnd, "Do you really want to exit?", "Confirmation", MB_OKCANCEL) != IDCANCEL)
						DestroyWindow(hWnd);
				   break;
				default:
	...
	switch (message)
	{
		...
		case WM_COMMAND:
			if (LOWORD(wParam) == IDOK || LOWORD(wParam) == IDCANCEL) 
			{
				...
				{
					if(MessageBox(hDlg, "Do you really want to exit?", "Confirmation", MB_OKCANCEL) == IDCANCEL)
						break;
				}
